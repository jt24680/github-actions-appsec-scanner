...
def _compile_regex(pattern: str, label: str) -> re.Pattern[str]:
    """Compile a regex with validation and a complexity ceiling."""
    # Reject patterns likely to cause catastrophic backtracking (ReDoS).
    # Nested quantifiers like (a+)+, (a*)+, (a+)*, (a*){2,} are the most
    # common source of exponential runtime in Python's re engine.
